...
const jobs: JobPosting[] = [
  ...
  },
  {
    ...
    employment: "Full time.",
    description:
      "Savekey Technology is looking for minimum 5 Years of SAP FI Hands on Experience with at least 2-3 SAP implementation Project Experience. Excellent knowledge on Accounts Receivable, JV, Asset Accounting, TDS, GST. Should be aware of Accounts Payable, Accounts Receivable, JV, Asset Accounting, TDS, GST. Should be able to give training to end user & support on documentation & other task assigned",
  },
  {
    id: 3,
  ...
  return (
    <div className="bg-white py-8 sm:py-12 md:py-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-brand-primary mb-6 sm:mb-8">
          Job Posting
        </h2>
        ...
        <div className="space-y-4 sm:space-y-6">
          {jobs.map((job) => (
            ...
            >
              ...
              <div
                className={`w-full sm:w-56 md:w-64 px-4 sm:px-6 py-4 sm:py-6 rounded text-white font-semibold flex-shrink-0 ${
